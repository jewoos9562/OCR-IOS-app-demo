...
class idcardViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    private func drawRectangle() {
        ...
        let rectSize = CGSize(width: 300, height: 190)
    ...
    private func showCapturedImage() {
        ...
        if let croppedCGImage = capturedImage.cgImage?.cropping(to: CGRect(origin: transformedOrigin, size: transformedRectSize)) {
            ...
            let showVC = idcardShowController()
...
//            UIImageWriteToSavedPhotosAlbum(croppedImage, self, #selector(image(_:didFinishSavingWithError:contextInfo:)), nil)
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            captureButton.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -60),
    ...
    private func finishCapturing() {
        if shouldCaptureImage{
            captureSession.stopRunning() // 촬영 중지
