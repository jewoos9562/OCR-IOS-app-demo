...
class LoadingdriverViewController: UIViewController {
                    ...
                    if let name = jsonObject["이름"] as? String,
                       ...
                       let drnum = jsonObject["운전면허증번호"] as? String {
                        DispatchQueue.main.async {
                            // RecognitiondriverViewController를 초기화하고 데이터를 설정한 후 전환
                            let recognitionVC = RecognitiondriverViewController()
